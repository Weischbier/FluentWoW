...
---@param cp number Unicode codepoint (0x0000–0xFFFF)
---@return string utf8 The encoded UTF-8 character
...
-- Organised by PUA range as published by Microsoft.
-------------------------------------------------------------------------------
...
-------------------------------------------------------------------------------
-- Build UTF-8 glyph strings (runs once at load time)
-------------------------------------------------------------------------------

local Icons = {}
for name, cp in pairs(CODEPOINTS) do
    Icons[name] = utf8char(cp)
end

-------------------------------------------------------------------------------
-- Expose on library namespace
-------------------------------------------------------------------------------

lib.Icons = Icons
lib.IconCodepoints = CODEPOINTS
