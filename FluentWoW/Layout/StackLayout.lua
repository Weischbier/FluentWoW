...
function FWoWStackLayout_OnLoad(self)
...
function FWoWStackLayout_OnSizeChanged(self)
...
---@return FWoWStackLayout
function lib:CreateStackLayout(parent, name, orientation)
    local f = CreateFrame("Frame", name, parent, "FWoWStackLayoutTemplate")
    ---@cast f FWoWStackLayout
