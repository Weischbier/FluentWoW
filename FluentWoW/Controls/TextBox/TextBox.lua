...
function FWoWTextBox_OnLoad(self)
...
function FWoWSearchBox_OnLoad(self)
    FWoWTextBox_OnLoad(self)
    self._isSearch = true
    if self.SearchIcon then
...
function FWoWTextBox_OnEscapePressed(self)
    self:ClearFocus()
end
...
function FWoWTextBox_OnLeave(self)
    if not self._enabled then return end
    if self._vsm:GetState() ~= "Focused" then
...
function FWoWTextBox_OnMouseDown(self)
...
function lib:CreateTextBox(parent, name)
    local f = CreateFrame("Frame", name, parent, "FWoWTextBoxTemplate")
    ---@cast f FWoWTextBox
    return f
end
...
function lib:CreateSearchBox(parent, name)
    local f = CreateFrame("Frame", name, parent, "FWoWSearchBoxTemplate")
    ---@cast f FWoWTextBox
    return f
end
