...
function FWoWScrollFrame_OnLoad(self)
...
function FWoWScrollFrame_Thumb_OnMouseUp(self)
    local parent = self:GetParent():GetParent()
...
---@param parent Frame
---@param name? string
---@return FWoWScrollFrame
function lib:CreateScrollFrame(parent, name)
    local f = CreateFrame("Frame", name, parent, "FWoWScrollFrameTemplate")
    ---@cast f FWoWScrollFrame
    return f
end
