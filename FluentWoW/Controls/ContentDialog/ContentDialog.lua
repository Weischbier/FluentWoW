...
function FWoWContentDialog_OnCloseClick(self)
...
function FWoWContentDialog_OnOverlayClick(self)
...
---@param name? string
---@return FWoWContentDialog
function lib:CreateContentDialog(parent, name)
    local f = CreateFrame("Frame", name, parent or UIParent, "FWoWContentDialogTemplate")
    ---@cast f FWoWContentDialog
    return f
end
