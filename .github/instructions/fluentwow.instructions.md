...
7. Never add new Lua globals — everything lives under `FluentWoW.*` (exception: `FWoW*` XML handlers)
...
- XML script handlers use global functions: `FWoW<ControlName>_<Event>`
...
- Always cross-reference `.help/.sources/WinUI-Gallery-main/fwow/Assets/Design/` for visual measurements
