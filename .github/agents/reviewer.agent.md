...
3. **Combat Safety** — InCombatLockdown guards where needed
4. **State Machine** — proper VSM usage
5. **Naming** — WUIL prefix, correct patterns
6. **Documentation** — all doc surfaces updated
7. **Gallery** — demo page exists and shows all variants
